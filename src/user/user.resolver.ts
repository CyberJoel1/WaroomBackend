...
export class UserResolver {
  ...
  @Mutation(() => User, {
    name: 'usercreate',
    description: 'Crear un usuario determinado',
  })
  ...
  @Query(() => [User], {
    name: 'findAllUser',
    description: ' Trae los usuarios de un determinado rol',
  })
  ...
  @Query(() => User, {
    name: 'getDataProfile',
    description: ' Trae los datos necesarios para el perfil',
  })
  ...
  @Query(() => User, {
    name: 'getDataProfileChat',
    description: ' Trae los datos necesarios para el chat',
  })
  ...
  @Mutation(() => Boolean)
  @UseGuards(JwtAuthGuard)
  async traeatedDenounceComment(
    @Args('treatedDenounceCommentInput')
    treatedDenounceCommentInput: TreatedDenounceCommentInput,
    @CurrentUser([validRoles.admin]) user: User,
  ) {
    try {
      await this.userService.blockUser(treatedDenounceCommentInput);
      await this.commentService.deleteDenounceByUserName(
        treatedDenounceCommentInput.userName,
      );
      await this.publicationService.deleteDenounceByUserName(
        treatedDenounceCommentInput.userName,
      );
      return true;
    } catch (error) {
  ...
  @Mutation(() => messageUpdate, {
    name: 'updateToUser',
    description: 'Va a actualizar el usuario',
  })
  @UseGuards(JwtAuthGuard)
  UpdateUserId(
